...
class RoomServiceImplTest {
    ...
    void throwsExceptionWhenDeletingRoom_AndUserIsNotOwner() {
        ...
        //then
        assertThrows(ForbiddenActionException.class, () -> roomService.delete(roomNameDto, notOwnerUser));
    }
    @Test
    ...
    void throwsExceptionWhenRenamingRoom_AndUserIsNotOwner() {
        ...
        doReturn(Optional.empty()).when(roomRepository).findByName(roomRenameDto.getNewName());
        //then
        assertThrows(ForbiddenActionException.class, () -> roomService.rename(roomRenameDto, otherUser));
    }
    @Test
